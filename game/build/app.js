  ...
  setSpriteSheet(name, direction, mode) {
    ...
    if (mode === "scared") {
      this.animationTarget.style.backgroundImage =
        "url(https://freepacman.org/app/style/graphics/" +
...
class Pacman {
  ...
  prepDeathAnimation() {
    ...
    this.animationTarget.style.backgroundSize = `${bgSize}px`;
    this.animationTarget.style.backgroundImage =
      "url(https://freepacman.org/app/style/" +
...
class GameCoordinator {
  ...
  preloadAssets() {
    return new Promise((resolve) => {
      ...
      const imgBase = "https://freepacman.org/app/style/graphics/spriteSheets/";
      const imgSources = [
        // Pacman
        ...
        // Misc
        "https://freepacman.org/app/style/graphics/extra_life.png",
      ];
  ...
  updateExtraLivesDisplay() {
    ...
    for (let i = 0; i < this.lives; i += 1) {
      ...
      extraLifePic.setAttribute(
        "src",
        "https://freepacman.org/app/style/graphics/extra_life.svg"
      );
